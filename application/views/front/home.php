<div id="slides" class="carousel slide carousel-cus" data-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="<?php echo base_url().'public/front/img/bg.jfif';?>" alt="FriesBrgrImg">
...
<div class="container-fluid padding">
    <div class="row text-center padding">
        <div class="col-xs-12 col-sm-6 col-md-4">
            ...
            <p>Hal pertama yang dapat Anda lakukan adalah memilih dari mitra restautant kami dengan mudah!</p>
        </div>
        <div class="col-xs-12 col-sm-6 col-md-4">
            <i class="fas fa-bullseye"></i>
            <h3>Pilih hidangan lezat</h3>
            <p>Kami membantu Anda dengan menu dari berbagai restoran pengiriman online!</p>
        </div>
